...
final class ProfilePageViewController: UIViewController {
    ...
    @objc func userDidLogin() {
        // Handle the user being logged in, update UI or perform any necessary actions
    ...
    // Inside the login function or wherever the login process is completed
    private func loginUser() {
        // Perform login process
        
        // Post a notification when login is successful
        NotificationCenter.default.post(name: .userLoggedIn, object: nil)
    }

    deinit {
        // Remember to remove observer when the object is deallocated
